...
import com.sonim.gifproject.util.AutoFitTextureView;
import com.sonim.gifproject.util.Camera2Listener;
import com.sonim.gifproject.util.CameraUtil;
...
public abstract class Camera2Fragment extends Fragment implements Camera2Listener {
    ...
    private static String mCameraId = CAMERA_BACK;
    ...
    /*protected void requestVideoPermissions() {
        if (CameraUtil.shouldShowRequestPermissionRationale(, Camera2PermissionDialog.VIDEO_PERMISSIONS)) {
